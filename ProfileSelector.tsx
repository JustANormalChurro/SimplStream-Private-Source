...
export function ProfileSelector({ onSelectProfile }: ProfileSelectorProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 4k:p-8 relative overflow-hidden bg-black">
      {/* Moving Aurora Background */}
      <div className="aurora-bg fixed inset-0 z-0 pointer-events-none" />
      
      <div className="relative z-10 text-center mb-12 4k:mb-24">
        <h1 className="text-4xl sm:text-6xl 4k:text-9xl font-bold mb-4 4k:mb-8 animate-fade-in text-white">
          <span className="text-blue-500">Simpl</span>Stream
        </h1>
        <p className="text-lg sm:text-xl 4k:text-4xl text-gray-400 animate-fade-in">
          Who's watching?
        </p>
      </div>

      <div className="relative z-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-8 4k:gap-16 mb-8 4k:mb-16">
        {profiles.map((profile) => (
          <div key={profile.id} className="relative group">
            <button
              onClick={() => handleSelectProfile(profile)}
              className="flex flex-col items-center gap-3 4k:gap-6 p-4 sm:p-6 4k:p-12 rounded-xl 4k:rounded-3xl transition-all duration-300 hover-lift hover:bg-white/5"
            >
              <div className="relative">
                <div
                  className="w-20 h-20 sm:w-32 sm:h-32 4k:w-64 4k:h-64 rounded-full flex items-center justify-center text-white text-2xl sm:text-4xl 4k:text-8xl font-bold shadow-2xl transition-transform duration-300 group-hover:scale-110 overflow-hidden"
                ...
                {profile.pin && (
                  <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 4k:-top-4 4k:-right-4 bg-green-500 rounded-full p-1 sm:p-2 4k:p-4 shadow-lg">
                    <Lock size={12} className="sm:w-4 sm:h-4 4k:w-8 4k:h-8 text-white" />
                  </div>
                )}
              </div>
              <span className="text-base sm:text-xl 4k:text-4xl font-medium text-white">{profile.name}</span>
            </button>
        ...
        <button
          ...
          className="flex flex-col items-center gap-3 4k:gap-6 p-4 sm:p-6 4k:p-12 rounded-xl 4k:rounded-3xl transition-all duration-300 hover-lift hover:bg-white/5 group"
        >
          <div className="w-20 h-20 sm:w-32 sm:h-32 4k:w-64 4k:h-64 rounded-full flex items-center justify-center bg-gray-800 transition-transform duration-300 group-hover:scale-110 shadow-xl">
            <Plus size={32} className="4k:w-24 4k:h-24 text-white transition-transform duration-300 group-hover:rotate-90" />
          </div>
          <span className="text-base sm:text-xl 4k:text-4xl font-medium text-white">Add Profile</span>
        </button>
      </div>
